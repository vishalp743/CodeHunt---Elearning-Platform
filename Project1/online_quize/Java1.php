...
<tr>
    ...
    <tr>
	  <td>
	  	<div>
	  		<p class="question">5. Which of this class contains methods use to write in a file</p>

	    	<ul>
	        <input class="answer" type="radio" name="q5" value="0">
	        <label>file stream</label>
	        <br>
	        <input class="answer" type="radio" name="q5" value="1">
	        <label id="correctString5">file input stream</label>
	        <br>
	        <input class="answer" type="radio" name="q5" value="0">
	        <label>Buffered Output Stream</label>
	        <br>
	        <input class="answer" type="radio" name="q5" value="0">
	        <label>File Buffer Stream</label>
    		</ul>
	  	</div>
	  </td>
	</tr>
	<tr>
	  <td>
	  	<div>
	  		<p class="question">6. Which keyword must be use to inherit a class ?</p>
	        ...
	        <label id="correctString6">Extends</label>
	        <br>
	        <input class="answer" type="radio" name="q6" value="0">
	        <label>extent</label>
	        <br>
	...
	<tr>
	  <td>
	  	<div>
	        ...
	        <label id="correctString7">correct answer 4</label>
	        <br>
	        <input class="answer" type="radio" name="q7" value="0">
	        <label>wrong answer</label>
	        <br>
	...
	<tr>
	  <td>
	  	<div>
	        ...
	        <label id="correctString8">correct answer 4</label>
	        <br>
	        <input class="answer" type="radio" name="q8" value="0">
	        <label>wrong answer</label>
	        <br>
	...
	<tr>
	  <td>
	  	<div>
	        ...
	        <label id="correctString9">correct answer 4</label>
	        <br>
	        <input class="answer" type="radio" name="q9" value="0">
	        <label>wrong answer</label>
	        <br>
	...
	<tr>
	  <td>
	  	<div>
	  		<p class="question">10. Packgae used for networking ?</p>
	        ...
	        <label id="correctString10">java.net.*</label>
	        <br>
	        <input class="answer" type="radio" name="q10" value="0">
	        <label>java.sql.*</label>
	        <br>
	        <input class="answer" type="radio" name="q10" value="0">
	        <label>java.servlet.*</label>
    		</ul>
	  	</div>
	  </td>
	</tr>
