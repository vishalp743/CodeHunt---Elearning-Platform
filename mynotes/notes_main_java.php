...
<div class="notesbody" style="background-image:url( img.jpg);margin-top :50px;height: 510px;color:black;margin-left:50px;margin-right:50px;">
    ...
    <div class="videoimg">  
     <iframe style="height: 250px; width : 300px; "scrolling="no" frameborder="0" name="<?php echo $videoid  ?>"  src=uploading/<?php echo $row['video_image']; ?> alt="Card image cap" allowfullscreen></iframe>
    </div>
    <div class="videolink">
