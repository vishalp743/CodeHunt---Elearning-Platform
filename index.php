			...
			<section class="slider text-center" id="slider">
				<div class="slider-overlay">
					<div class="slider-content">
						...
						<br>
						<div class="">  
							<h1 style="color:red;text:bold"><b>WELCOME, </b><span style="color:white"><b>YOU ARE AT RIGHT PLACE</b></span></h1></b>
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/profile.php?id=100008334708685" class="fa fa-facebook"></a>
								<a href="https://twitter.com/codehunt_" class="fa fa-twitter" target="_blank"></a>
								<a href="https://www.instagram.com/codehunt_insta/" target="_blank"class="fa fa-instagram"></a>
								
								<a href="https://www.linkedin.com/in/code-hunt-52396123a/" class="fa fa-linkedin" target="_blank"></a>
         	...
         	<div class="row">
         		...
         		<div class="col-md-6 col-sm-6 col-xs-12 ">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="quizehome.php">LANGUAGE TOPICS QUIZ</a></h3>    exercise/exercise.php 
         				<p>
				 ...
				 <div class="col-md-6  col-sm-6 col-xs-12 ">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="online_quize/quizhome.php">CERTIFICATE</a></h3>     exercise/exercise.php 
         				<p>
				...
				<div class="container-fluid">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work.png" title="Coding">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/lang_work.jpeg" title="Computer Language">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/android_work.jpg" title="Android Programming">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/compilers_work.jpg" title="Compiler">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work5.png" title="Quiz">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/java_work.jpeg" title="Java Programming">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/notes_work.jpg" title="Notes">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/pythone_work.jpg" title="Python">
	   ...
	   <h5 style="text-align:center;">Team Full Of Youngs & Smart Minds</h5>
        ...
        <div class="team">
			<div class="team_member">
				<div class="team_img">
                   <img src="Vishal-img.jpg" alt="team_member_img">
				</div>
			 <h3>Vishal Patil</h3>
			 <p class="role">Backend</p>
			 <p >CodeHunt Devlopers</p>
			</div>
     	

		    <div class="team_member">
			<div class="team_img">
                   <img src="suraj-img.jpg" alt="team_member_img">
				</div>
			 <h3>Suraj Darade</h3>
			 <p class="role">GUI Development</p>
			 <p >E-Education Devloper</p>
			</div>
     	</div>
...
<<div class="row text-center" id="contact">
	...
	<iframe height="600px" width="900px" src="../mail.php " frameBorder="0">
